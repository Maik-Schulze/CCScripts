...
Program to be able to download programs on GitHub.
...
--if the parameter table has more or less entries then 3 give out an error message and quit.
if (argc ~= 3) then
	print("Syntax Error.")
	print("For tips on correct usage type 'github help'.")
	return
...
local github_url = "https://raw.github.com/..argt[2]
